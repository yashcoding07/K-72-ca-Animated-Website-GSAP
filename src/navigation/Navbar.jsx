...
const Navbar = () => {
    ...
    return (
        <div className="w-full fixed top-0 z-4 flex items-start justify-between">
            <div className="p-2.5">
                <div className="w-30">
            ...
            <div onMouseEnter={() => navGreenRef.current.style.height = "100%"} onMouseLeave={() => navGreenRef.current.style.height = "0%"} className="relative w-[16vw] h-12 bg-black">
                <div ref={navGreenRef} className="bg-[#D3FD50] h-0 w-full absolute top-0 transition-all cursor-pointer"></div>
